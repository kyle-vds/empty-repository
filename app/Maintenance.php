	...
	<div class="wrapper">
		<div role="main" class="main">
			<div class="row-fluid">
				...
				<p>The webmaster or another administrator has put the site into
					maintenance mode. This means that public access to the web
					front-end has been disabled.</p>

				<h3>What's going on?</h3>

				<p>It is likely that the database is being updated to reflect the
					latest available information, or that the underlying codebase is
					being upgraded to the newest version.</p>
